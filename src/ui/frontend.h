...
typedef struct
{
    ...
    bool nome_para_memoria;  
    /* true → vai p/ memória; false → vai p/ dificuldade */
    ...
    /* Cache de histórico (carregado uma vez ao entrar na tela) */
    bool hist_carregado;
    RegistroPartida hist_adiv[20];
    int  hist_adiv_n;
    RegistroMemoria hist_mem[20];
    int  hist_mem_n;
} EstadoUI;
